...
**Animation is a separate system** (`Source/Holypaw/Anim/HolypawProcAnim.cpp`). Pretty meshes still feel like a prototype if they do not move. The conversion fantasy is authored clips: **wrap**, **blink**, **ear flop**, **kneel**, **party trail**, **victory**. Humans bow when they convert, kneel for the peak miracle, fluffies flop their ears while they wander, and party members hop along the teddy's trail. Clip names stay the contract for later skeletal anims.
