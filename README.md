...
Dressed cities so far (**18 / 26**): Ribbon City, Tidewell, Hearthfold, Emberfen, Snowveil, Lantern Angeles, Mossgate, Palma Dusk, Cherry Loom, **Quiltland**, **Dust Mesa**, **Clockhaven**, **Velvet Seine**, **Marble Forum**, **Ivory Spire**, **Sand Hymn**, **Cape Plush**, **Savannah Bell**. Each has districts, an inn, a font or chapel, a pickup, and an errand. Remaining kits: Carnival Bahia, Andes Loom, Silk Delta, Spice Harbor, Coral Choir, Aurora Borough, Tundra Parish, Felt Ice Camp. Talk runs through `HolypawDialogueVM`. Combat incoming specials, lullaby, hit-stop, and ability costs run through `HolypawBattleDirector`.
