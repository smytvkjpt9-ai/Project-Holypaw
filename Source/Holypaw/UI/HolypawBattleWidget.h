...
#include "HolypawBattleWidget.generated.h"

/**
 * Turn-based battle / skills / party overlay.
 * Built in C++ (no Widget Blueprint) so the cloud repo stays playable after compile.
 */
UCLASS()
class HOLYPAW_API UHolypawBattleWidget : public UUserWidget
{
	GENERATED_BODY()
