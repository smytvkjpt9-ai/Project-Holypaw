...
Dressed cities: **all 26**. Each has districts, a walk-in inn, a walk-in shop, a font or chapel, a pickup, and an errand. The **Poly Mill** is a hall you enter (conveyors, vats, west door toward Ribbon). **Ribbon conversion is visible:** mill banners sag then fall, stalls unlatch, believers clap-walk plaza loops, dusk hymn when three Hearts stick. Humans follow a **day / dusk / night** beat: wander, chapel hymn, inn pile-in. Talk runs through `HolypawDialogueVM`. Combat pages, roles, and boss kits run through the director. City theme pads are procedural sines (TEMP). Still not 24 NPCs per city, Nanite, or a Shipping `.exe`.
